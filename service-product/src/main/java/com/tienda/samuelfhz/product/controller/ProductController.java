...
public class ProductController {
    ...
    public ResponseEntity<Product> updateProduct(@PathVariable("id") Long id, @RequestBody Product product){
        ...
        return productDB == null ? ResponseEntity.notFound().build() : ResponseEntity.ok(productDB);
    }
    ...
    public ResponseEntity<Product> deleteProduct(@PathVariable("id") Long id){
        ...
        return productDelete == null ? ResponseEntity.notFound().build() : ResponseEntity.ok(productDelete);
    }

    @GetMapping(value = "/{id}/stock")
    public ResponseEntity<Product> updateStockProduct(@PathVariable("id") Long id, @RequestParam(name = "quantity",
